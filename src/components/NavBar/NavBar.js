          ...
          <ul className="menu menu-horizontal p-0 bg-base-300 font-bold rounded-lg">
            ...
            <li tabIndex={0}>
              ...
              <ul style={{zIndex:1}} className="p-2 bg-base-100 bg-base-200 rounded-sm ">
                <li><Link to={`/category/:id`} >Survival </Link></li>
                <li><Link to={`/category/:id`} >Survival Horror</Link></li>
                <li><Link to={`/category/:id`} >Arcade</Link></li>
                <li><Link to={`/category/:id`} >Space</Link></li>
                <li><Link to={`/category/:id`} >Adventure</Link></li>
                <li><Link to={`/category/:id`} >Indie</Link></li>
              </ul>
